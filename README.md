...
5 катогрий, более 20 3D-моделей.

Модели можно открывать как в AR, так и в 3D.

Изучай как строились аппратаы напрямую на сайте NASA.
...
Повзоляет искать коктейли по категориям и ингидентам. Сохранять понравившиеся коктейли и готовить их в свобдное время.
Версия iPad сделана адаптация для отображении на экране ордновременно открытых двух приложений.
...
Анимация:
- При выборе теста осуществялется планвй переход по фотографии и тексту.
